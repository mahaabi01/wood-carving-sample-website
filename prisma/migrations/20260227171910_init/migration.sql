-- CreateEnum
CREATE TYPE "Role" AS ENUM ('USER', 'ADMIN', 'ARTISAN');
...
CREATE TABLE "blog_posts" (
    ...
    "tags" TEXT[],
    "author" TEXT NOT NULL DEFAULT 'Om Wood Carving',
...
CREATE TABLE "heritage_articles" (
    ...
    CONSTRAINT "heritage_articles_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "heritage_articles_slug_key" ON "heritage_articles"("slug");
